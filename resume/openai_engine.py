...
def send_openai_message(user_message:str, meta_prompt:str = None, model:str = "gpt-4o-mini", is_json:bool = False):
    """
...
def extract_resume_data(user_message: str):
    ...
    return send_openai_message(
        user_message=user_message, meta_prompt=meta_prompt, model="gpt-4o-mini", is_json=True
    )
